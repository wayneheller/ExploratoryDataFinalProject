...
# createPlot2 makes a plot using the base plotting system showing the total 
...
createPlot2 <- function() {
    ...
    emissionsByYear <- with(dfNEIBaltimoreCity, tapply(Emissions, year, sum))
    ...
    devPNG <- png("plot2.png", width=650)
    
    par(las=1) # Set Y axis label to print horizontally
    
    # Plot the total amount of emissions by year in Kilotons
